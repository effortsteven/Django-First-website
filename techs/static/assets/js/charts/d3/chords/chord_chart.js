    ...
    d3.chart.chord = function(container) {
        ...
        self.render = function() {
            ...
            svg.append("g")
                ...
                .enter()
                .append("path")
                    .style("fill", function(d) { return fill(d.inner_base); })
                    .style("stroke", function(d) { return fill(d.inner_base); })
            ...
            svg.append("g")
                ...
                .append("path")
                    ...
                    .style("fill", function(d) { return fill(d.target.inner_base); })
                    .style("stroke", "#000")
    ...
    function fade(opacity, svg) {
        return function(g, i) {
            svg.selectAll(".d3-chord path").filter(function(d) {
                return d.source.inner_base != i && d.target.inner_base != i;
            })
            .transition()
